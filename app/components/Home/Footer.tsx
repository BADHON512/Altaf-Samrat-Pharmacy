...
<footer className="bg-gray-900 text-white">
    ...
    <div className="container mx-auto px-4 flex flex-col md:flex-row items-center justify-between gap-8">
      ...
      <div className="w-full md:w-auto flex items-center">
        <input
          ...
          className="w-full md:w-64 p-2 rounded-l-md border-none focus:outline-none"
        />
        <button className="bg-white text-teal-600 font-semibold py-2 px-4 rounded-r-md hover:bg-gray-100 transition">
          Subscribe
        </button>
      </div>
      <div className="w-full md:w-1/3 flex justify-end">
        <div className="w-full h-32 bg-gray-300 rounded-lg"></div> {/* Placeholder for image */}
      </div>
    </div>
  </div>
  ...
  <div className="container mx-auto px-4 py-8 grid grid-cols-1 md:grid-cols-4 gap-8">
    ...
    <div>
      ...
      <ul className="space-y-2">
        <li className="text-gray-400">📍 Postkamari Nagarpur Tangail</li>
